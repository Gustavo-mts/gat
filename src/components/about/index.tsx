  ...
  return (
    <section className="flex justify-center bg-[#efefef]">
      ...
      <div className="
        ...
        max-w-[1280px] xl:max-w-[1280px] 2xl:max-w-[1600px]
      ...
      ">
        ...
        <div className="w-1/2 py-16 relative">
          ...
          <img
            src={ElipseRed}
            className="
              w-[272px] h-[272px] ml-72
              xl:w-[272px] xl:h-[272px] xl:ml-72
              2xl:w-[320px] 2xl:h-[320px] 2xl:ml-[22rem]
            "
          />
          ...
          <h1
            className="
              ...
              font-sora font-normal text-[70px] leading-none tracking-normal
              xl:w-[396px] xl:ml-52 xl:mt-[-180px] xl:text-[70px]
              2xl:w-[480px] 2xl:ml-[15rem] 2xl:mt-[-210px] 2xl:text-[86px]
            "
          >
        ...
        <div className="w-1/2 flex flex-col justify-center">
          ...
          <img
            src={RetanlgeCats}
            className="
              w-[505px] h-[284.0625px]
              xl:w-[505px] xl:h-[284.0625px]
              2xl:w-[600px] 2xl:h-[337.5px]
            "
          />
          ...
          <p
            className="
              ...
              xl:text-[14px] xl:leading-[25px]
              2xl:text-[16px] 2xl:leading-[28px] 2xl:max-w-[640px]
            "
          >
          ...
          <button
            className="
              ...
              text-[17px] leading-none tracking-normal mt-6 py-4 pl-8 pr-4
              xl:w-[225px] xl:text-[17px]
              2xl:w-[260px] 2xl:text-[18px] 2xl:py-5 2xl:pl-9 2xl:pr-5
