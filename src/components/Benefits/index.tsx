        ...
        <div className="w-[90%] h-[238px] bg-[#DE5A53] text-white flex px-6 py-6 xl:px-12 xl:py-8 2xl:px-16 2xl:py-10">
          ...
          >
            ...
            <div className="flex flex-col justify-center gap-3 xl:gap-4">
              <h2 className="font-sora font-bold text-[24px] xl:text-[30px] 2xl:text-[34px] leading-[100%]">
                Benefício Principal
              </h2>
              <p className="font-sora font-light text-[12px] xl:text-[14px] 2xl:text-[16px] leading-[120%]">
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="min-h-[120px] xl:min-h-[115px] py-3 px-4">
                  <div className="flex items-start gap-2">
                    <img src={Prize} className="w-5 h-5 xl:w-6 xl:h-6 2xl:w-7 2xl:h-7" alt="Ícone de prêmio ou destaque" />
                    <h3 className="font-sora font-bold text-[18px] xl:text-[22px] leading-[110%]">
